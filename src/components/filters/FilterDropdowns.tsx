...
export function FilterDropdowns({
  ...
  const updateRetailers = (values: string[]) =>
    onFiltersChange({ ...globalFilters, retailers: values });
  const updateSettlements = (values: string[]) =>
    onFiltersChange({ ...globalFilters, settlements: values });
  const updateMunicipalities = (values: string[]) =>
    onFiltersChange({ ...globalFilters, municipalities: values });
  const updateCategories = (values: string[]) =>
    onFiltersChange({ ...globalFilters, categories: values });
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
          {!useSimpleInputs ? (
            <>
              ...
              <div>
                ...
                <MultiSelect
                  ...
                  placeholder={
                    retailersLoading ? "Loading..." : "Select retailers..."
                  }
              ...
              <div>
                ...
                <MultiSelect
                  ...
                  placeholder={
                    settlementsLoading ? "Loading..." : "Select settlements..."
                  }
            ...
            <>
              ...
              <div>
                <Label htmlFor="settlements">
                  Settlements (comma-separated)
                </Label>
                <Input
                  id="settlements"
        ...
        <div className="flex gap-2 mb-4">
          <Button
            variant="outline"
            size="sm"
            onClick={() => applyTestFilters("empty")}
          >
            Clear All
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => applyTestFilters("basic")}
          >
            Date Only
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => applyTestFilters("filtered")}
          >
            Sample Filters
          </Button>
          <Button
