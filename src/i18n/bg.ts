...
export const content = {
  ...
  hero: {
    ...
    subtitle:
      "Присъедини се към общността на Мерим(.бг). Правете информиран избор относно всяка покупка. Сравнявайте цените при продукти от всеки магазин, директно от телефона си.",
  },
  appButtons: {
  ...
  solution: {
    title: "Силата е във вашите ръце. Или в телефона ви.",
